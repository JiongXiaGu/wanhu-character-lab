...
export async function checkCamelBrowser(page, base, checks) {
  ...
  checks.push('camel native URL and four independent clips; 2280 triangles/29 bones; two fields/three animal sections/one canvas; no-saddle body-to-riding does not auto-equip');

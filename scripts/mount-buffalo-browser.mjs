...
export async function checkBuffaloBrowser(page, base, checks) {
  ...
  checks.push('buffalo native URL and four independent clips; 2056 triangles/28 bones; two fields/two modes/one canvas; no-saddle body-to-riding does not auto-equip');
  ...
  for (const [id, bones, duration] of [['horse_chestnut', 25, 1.2], ['donkey_gray', 27, 1.4], ['camel_bactrian', 29, 1.6], ['cattle_yellow', 28, 1.8], ['buffalo_water', 28, 2.0]]) {
  ...
  for (const id of ['horse_chestnut', 'donkey_gray', 'camel_bactrian', 'cattle_yellow', 'buffalo_water']) {
  ...
  checks.push('buffalo male/female × simple/travel × three rider clips; species preserve rider/appearance/camera/phase; none freezes across all five species; wardrobe and replay remain valid');

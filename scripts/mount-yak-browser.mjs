...
export async function checkYakBrowser(page, base, checks) {
  ...
  checks.push('yak native URL and four independent clips; 2328 triangles/29 bones; two fields/three animal sections/one canvas; no-saddle body-to-riding does not auto-equip');

...
}finally{await context.close();await browser.close();await writeFile(dir+'/visual.json',JSON.stringify({testedSha:process.env.REVIEW_HEAD_SHA,priority,shots,videos,errors,generated:true,manuallyReviewed:false},null,2));}

...
Heavy 采用共享 `heavy_armor` + `heavy_armor_skirt`，搭配三驻地各自的普通/队长重盔。第一轴是轻/中/重甲，第二轴是驻地 palette + helmet，第三轴是仅改变 headwear 的普通/队长；Recipe V5 不扩字段。

本次将高胯宽裤管改为连续前后围裳，活动分叉下移到近膝部，外甲摆延伸过膝，保留两个真实腿出口。下装352三角形/178逻辑顶点，上甲432/218不变。末端仍有低开衩，不是完全无开衩或拖地的长裙；是否达到全副武装重步兵观感由实际截图与用户审查判断。

人物工坊右侧「军人试衣 → 甲装等级 → 重甲」进入；驻地和普通/队长继续独立切换，头饰和衣裤也可单件混搭。2026-09-26 用户要求将 PR #66 正常合入 main 以亲自审查。更新时拉取最新 main 并重启开发服务；是否合并及精确 SHA 以 GitHub PR #66 为准，分支测试与 main 复检分别记录。

正式检查通过、截图生成、AI看图、main交付与用户美术认可分开记录；不把“已合并”当作造型最终定稿。不做旧数据兼容，不增加骨骼、Renderer、武器、军种或玩法。共用规则见 [军人与甲胄工作流](Documentation/军人与甲胄工作流.md)。
...
原人物工坊新增城市整套：低檐盔、窄肩布面短甲、外露腰带与束腿军裤，复用军靴和长枪。入口 `?soldier=city&pose=bind&paused=1&view=free`；三套在原右侧军人试衣中切换，存档仍为V5六字段/七槽位/20骨。详见[城市守军与长枪](Documentation/城市守军与长枪.md)。新增真实三套同机位对比，不以整套换色或额外页面冒充新风格。精确受测SHA、正式检查和实际看图见本轮PR，用户美术认可单独验收。下方S1/S2章节为对应阶段记录，其城市未开放限制由S3替代；S4身份扩展见上方说明。
...
人物工坊右侧「军人试衣」新增真实边军整套，三件独立资产为护颈盔、厚札甲、腰起长甲裙，复用军靴与长枪。入口 `?soldier=frontier&pose=bind&paused=1&view=free`，三视图/俯视仍用原视图按钮。低盔、长护颈、厚胸、收肩和较长下摆区别于宫卫，非换色复制；原宫卫短甲裙保持。

五件装备合计 984 三角形，默认整套男女分别 1177 / 1179。仍是 Recipe V5 六字段、七槽位、20 骨和最多双权重；保存、恢复、撤销及文件往返走原系统。专项现覆盖两套真实资产、源键/中点和同机位对比；自动检查、实际看图与用户美术认可在 PR 中分开记录。详见[边疆戍卒与长枪](Documentation/边疆戍卒与长枪.md)。城市仍未开放，不包含战斗或专用长枪动作。

## S1：皇宫禁卫 · 长枪

人物工坊右侧「军人试衣」可应用宫卫红缨盔、札甲、腰起短甲裙与裤管、短筒军靴和长枪，五件也能在原槽位独立混搭。整套应用保留当前男女、发式和发色，仍为Recipe V5、七槽位、20骨；不会把士兵加入默认平民随机池。

入口 `?soldier=palace&pose=bind&paused=1`；加 `&view=overview` 为经营俯视。甲裙按最新圈图反馈重做为从腰部垂下的完整短裙轮廓，不再是短裤外挂板。五件几何共978三角形，整套男女分别1171/1173三角形。长枪随右手变换，尚无专用持枪战斗动作；边疆现见 S2，城市没有空模型占位。详见[皇宫禁卫与长枪](Documentation/皇宫禁卫与长枪.md)及[长期工作流](Documentation/军人与甲胄工作流.md)。

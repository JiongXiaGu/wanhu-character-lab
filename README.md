...
候选预算：上甲568三角形/286逻辑点，长甲裳292/148，普通重盔188/98、队长重盔218/115。队长顶饰保持细高、居中、收尖、竖向；三驻地衣甲共用真实几何，只换配色和盔型。
...
体验候选须切到本轮 PR 分支，进入原人物工坊右侧「军人试衣 → 重甲」；main 在本轮合并前仍是上一版，不能宣称仅刷新 main 即可看到新模型。

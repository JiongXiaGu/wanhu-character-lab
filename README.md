...
已建立军人外观专项，固定三种驻地风格：皇宫禁卫、边疆戍卒、城市守军。三者与兵种、军阶分离；Web 继续只负责外观、蒙皮、动作和中远景识别，不实现战斗、编制或 AI。第一件真实资产按“皇宫禁卫 · 长枪”制作，之后依次验证边疆与城市风格。

军人继续复用 Recipe V5 七槽位和现有 20 骨人物，不新增职业字段或第二套 Renderer。当前 S0 仅加入作者契约、计划资产 ID 与 `check:soldier`；没有可见军装占位，也不恢复已经退役的旧军装。完整阶段、甲裙/护肩蒙皮边界、预算和 GitHub 检查见[军人与甲胄工作流](Documentation/军人与甲胄工作流.md)。

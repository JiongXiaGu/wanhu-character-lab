...
《万户天工》3D玩家／居民换装、FBX试衣与坐骑Web Demo。固定成年男女、一档低模精度；当前坐骑是栗色马、灰驴和双峰骆驼。界面只选择种类与整体鞍具，正式玩法仍留在Unity。
...
新增camel_bactrian双峰骆驼。独立作者网格1792三角形、958逻辑点、29骨骼（硬边拆点5376），突出双峰、弯曲长颈、长腿、宽脚垫和前双趾；不是马／驴的缩放变形。三段颈部、三段尾与双耳有真实轨道，驼峰只随躯干蒙皮。
...
相同风格按当前物种使用专属几何和坐点：灰驴较窄鞍具、骆驼两峰间坐垫均不直接套用原马模型。普通／旅行互换不重建当前动物、人物或绳网格，也不重置相位与相机。无鞍具隐藏骑手／骨架／绳，冻结骑乘但保留原装扮和进度；冻结期间可换物种，仍保留无鞍状态。
...
灰驴检查覆盖964本体姿态、2892稠密有鞍骑乘姿态、70衣裤关键相位、20次物种往返与错误／释放验证。新增骆驼964本体、2892骑乘、70衣裤、24次三物种切换及14个故障反例；检查脚轨迹方向、面部小壳贴合、两峰间坐点与缰绳避峰。原骑乘1446、原马具1452＋484及原Horse964姿态等回归保留。报告产物mounts-m4-checks记录实际sourceSHA，浏览器只做交互，不自动生成图片。

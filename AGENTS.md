...
用户已授权鸡、鸭、鹅增加睡觉动画。先读 `Documentation/家禽睡觉动作.md`。本轮新增陆地sleep，不扩展水上睡眠、日常混合池、入睡起身过渡、昼夜AI或猪犬动作。原作者网格、绑定、骨数与全部旧动作保持；旧四／七／八动作数量由当前五／八／九动作取代。沿用原三条正式Actions，临时作者工具不得留入最终main。交付需实际查看新版本WebGL截图，不将数值通过视为用户美术认可。

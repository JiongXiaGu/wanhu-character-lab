## S5：军人甲装改为“等级主轴，驻地配色/头盔副轴”

用户已明确否定继续为皇宫/边疆各维护一套非常相似的甲胄。当前正式中甲为 `medium_armor` + `medium_armor_skirt`：上甲来自保留的宫卫甲几何，下装来自保留的边军长甲裙几何；皇宫和边疆必须共享这两件资产，只通过头盔/队长顶饰和 palette 区分。城市现有布面短甲/军裤归为当前轻甲。重甲留给下一阶段，不能提前注册占位。

已删除边军厚甲、皇宫甲裙与裤装，并退役四个驻地专属衣甲 ID：`palace_guard_armor`、`frontier_lamellar_armor`、`palace_guard_skirt`、`frontier_armor_skirt`。严格 V5 文件入口不迁移这些旧 ID；prototype 中需重新选择中甲并导出。不得为兼容恢复旧工厂或双份近似几何。原普通/队长头盔、军靴、长枪、20骨、七槽位、固定男女和动作检查保持。
...
边军三件真实资产已接入原工坊，与宫卫共享军靴、长枪、Recipe V5和七槽位。先读《边疆戍卒与长枪》；前后整体长甲裙、厚胸护领、低盔长护颈必须靠真实几何区分宫卫，不能整套换色或开放城市占位。宫卫工厂和短甲裙检查保持。

边军独立作者几何不调用宫卫/居民裙工厂，最多双权重，不增骨、Renderer、身份字段或动作豁免。原完整下身源键/中点、Snatch、六坐骑回归不缩减；普通浏览器与显式截图分开。临时源码快照不可留入最终树；实际受测SHA、正式Actions、实际看图及用户认可分别记录，未完成验收不合并。

## S1 皇宫禁卫与长枪

用户已授权制作第一套真实宫卫。先读 `Documentation/皇宫禁卫与长枪.md` 和《军人与甲胄工作流》。五件新资产已走原七槽位、固定成年男女、20骨与最多双权重；`src/soldier/looks.ts`只应用外观，不另建Renderer、动画播放器、兵种或军阶协议。旧军服与boots仍退役，边疆现见 S2，城市仍仅为规划，不开放空选项。

用户最新圈图反馈已否定六片大腿外挂板。上甲与护肩保持原样；下装改成从腰部垂下、前后跨中线的整体短甲裙，裙底连接两个拱起裤腿出口，形成单一闭合壳。腰围随Hips，裙身渐进分担到对应Thigh，单点最多双权重；不调用居民裙装封底或豁免。原裤装/居民裙资产不改；军靴仍只覆盖foot。原下身源键/中点检测、Snatch压力片段、固定身体与inverse bind不变，不加军装豁免。长枪只随RightHand，不宣称专用站岗、刺击、双手握枪或战斗已实现。

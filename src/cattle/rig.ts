...
export const CATTLE_RIG_VERSION = 'wanhu-cattle-rig-m6-v1';
...
export const CATTLE_JOINTS: readonly HorseJoint[] = [
  ...
  { name: 'FrontLeftMiddle', parent: 7, bindWorld: [-.31, .62, .54] },
  { name: 'FrontLeftLower', parent: 8, bindWorld: [-.31, .18, .54] },
  { name: 'FrontLeftFoot', parent: 9, bindWorld: [-.31, .075, .60] },
  { name: 'FrontRightUpper', parent: 3, bindWorld: [.31, 1.12, .48] },
  { name: 'FrontRightMiddle', parent: 11, bindWorld: [.31, .62, .54] },
  { name: 'FrontRightLower', parent: 12, bindWorld: [.31, .18, .54] },
  { name: 'FrontRightFoot', parent: 13, bindWorld: [.31, .075, .60] },
  { name: 'BackLeftUpper', parent: 1, bindWorld: [-.32, 1.12, -.62] },
  { name: 'BackLeftMiddle', parent: 15, bindWorld: [-.32, .78, -.43] },
  { name: 'BackLeftLower', parent: 16, bindWorld: [-.32, .35, -.67] },
  { name: 'BackLeftFoot', parent: 17, bindWorld: [-.32, .075, -.62] },
  { name: 'BackRightUpper', parent: 1, bindWorld: [.32, 1.12, -.62] },
  { name: 'BackRightMiddle', parent: 19, bindWorld: [.32, .78, -.43] },
  { name: 'BackRightLower', parent: 20, bindWorld: [.32, .35, -.67] },
  { name: 'BackRightFoot', parent: 21, bindWorld: [.32, .075, -.62] },

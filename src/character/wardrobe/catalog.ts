...
export const SLOT_OPTIONS: { [K in keyof CharacterSlots]: readonly {id:CharacterSlots[K];name:string}[] } = {
  ...
  bottom:[{id:'medium_armor_skirt',name:'中甲长甲裙与裤装'},{id:'heavy_armor_skirt',name:'重甲宽甲裙与裤装'},{id:'city_guard_trousers',name:'轻甲束腿军裤'},{id:'short_trousers',name:'封口短裤'},{id:'true_short_skirt',name:'日常短裙'},{id:'long_skirt',name:'素面长裙'},{id:'work_pants',name:'劳动直裤'},{id:'work_wrap',name:'劳作束脚裤'},{id:'body',name:'无下装'}],

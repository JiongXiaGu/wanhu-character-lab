...
export const SLOT_OPTIONS: { [K in keyof CharacterSlots]: readonly {id:CharacterSlots[K];name:string}[] } = {
  headwear:[{id:'palace_heavy_helmet',name:'宫卫重盔'},{id:'palace_heavy_captain_helmet',name:'宫卫队长重盔'},{id:'frontier_heavy_helmet',name:'边军重盔'},{id:'frontier_heavy_captain_helmet',name:'边军队长重盔'},{id:'city_heavy_helmet',name:'城军重盔'},{id:'city_heavy_captain_helmet',name:'城军队长重盔'},{id:'palace_guard_helmet',name:'宫卫红缨盔'},{id:'palace_captain_helmet',name:'宫卫队长高束缨盔'},{id:'frontier_guard_helmet',name:'边军护颈盔'},{id:'frontier_captain_helmet',name:'边军队长束缨尖盔'},{id:'city_guard_helmet',name:'城军低檐盔'},{id:'city_captain_helmet',name:'城军队长窄竖冠盔'},{id:'none',name:'无头饰'},{id:'cloth_wrap',name:'素布包巾'},{id:'scholar_cap',name:'方冠'},{id:'jade_pin',name:'玉色簪饰'},{id:'farmer_straw_hat',name:'草帽'},{id:'guard_helmet',name:'轻盔'},{id:'archer_headband',name:'头巾'}],
  top:[{id:'medium_armor',name:'中甲札甲'},{id:'heavy_armor',name:'重甲胸腹甲'},{id:'city_guard_brigandine',name:'轻甲布面短甲'},{id:'work_vest',name:'干活背心'},{id:'short_work_jacket',name:'短打短褂'},{id:'rough_tunic',name:'劳作短衣'},{id:'cross_jacket',name:'交领常服'},{id:'layered_vest',name:'半臂配内衬'},{id:'ceremony_robe',name:'滚边礼衣'},{id:'farmer_tunic',name:'农户短衣'},{id:'body',name:'无上衣'}],
  bottom:[{id:'medium_armor_skirt',name:'中甲长甲裙与裤装'},{id:'heavy_armor_skirt',name:'重甲长围裳'},{id:'city_guard_trousers',name:'轻甲束腿军裤'},{id:'short_trousers',name:'封口短裤'},{id:'true_short_skirt',name:'日常短裙'},{id:'long_skirt',name:'素面长裙'},{id:'work_pants',name:'劳动直裤'},{id:'work_wrap',name:'劳作束脚裤'},{id:'body',name:'无下装'}],

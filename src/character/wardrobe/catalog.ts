...
export const WARDROBE_LOOKS: readonly LookDefinition[] = [
  ...
  {id:'town-female',name:'杏衫青裙',family:'市井',description:'交领袄衫 · 交叠裙摆',suggestedBody:'female',slots:slots('cross_jacket','pleated_skirt'),dyes:{primary:'#d3b08b',secondary:'#537775',accent:'#ece0c4'},hairStyle:'low_bun'},
  {id:'elegant-male',name:'月白雅服',family:'雅居',description:'半臂叠穿 · 长裳垂线',suggestedBody:'male',slots:slots('layered_vest','robe_skirt','scholar_cap'),dyes:dyes(3),hairStyle:'topknot'},
  ...
  {id:'ceremony-female',name:'黛紫宫装',family:'礼仪',description:'舒展袖形 · 长裳与簪饰',suggestedBody:'female',slots:slots('ceremony_robe','robe_skirt','jade_pin'),dyes:dyes(4),hairStyle:'topknot'},
];
...
export const SLOT_OPTIONS: { [K in keyof CharacterSlots]: readonly {id:CharacterSlots[K];name:string}[] } = {
  ...
  bottom:[{id:'loose_trousers',name:'收口布裤'},{id:'work_wrap',name:'劳作短围裳'},{id:'pleated_skirt',name:'交叠褶裙'},{id:'robe_skirt',name:'长裳'},{id:'work_pants',name:'原版劳动裤'},{id:'guard_pants',name:'卫兵裤'},{id:'archer_pants',name:'弓手裤'},{id:'body',name:'无下装'}],

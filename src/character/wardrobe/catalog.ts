...
export const WARDROBE_LOOKS: readonly LookDefinition[] = [
  ...
  {id:'lightwork-female',name:'轻装围裳',family:'轻便',description:'短袖短打 · 分片裙裤（非连续短裙）',suggestedBody:'female',slots:slots('short_work_jacket','short_skirt'),dyes:{primary:'#a67568',secondary:'#526b68',accent:'#d5bc8f'},hairStyle:'low_bun'},
...
export const SLOT_OPTIONS: { [K in keyof CharacterSlots]: readonly {id:CharacterSlots[K];name:string}[] } = {
  ...
  top:[{id:'work_vest',name:'干活背心'},{id:'short_work_jacket',name:'短打短褂'},{id:'rough_tunic',name:'劳作短衣'},{id:'cross_jacket',name:'交领常服'},{id:'layered_vest',name:'半臂配内衬'},{id:'ceremony_robe',name:'滚边礼衣'},{id:'farmer_tunic',name:'农户短衣'},{id:'guard_light_armor',name:'轻甲'},{id:'archer_tunic',name:'弓手短衣'},{id:'body',name:'无上衣'}],
  bottom:[{id:'short_trousers',name:'封口短裤'},{id:'true_short_skirt',name:'日常短裙'},{id:'long_skirt',name:'素面长裙'},{id:'short_skirt',name:'分片裙裤·旧短下裳'},{id:'loose_trousers',name:'直筒布裤'},{id:'work_wrap',name:'劳作束脚裤'},{id:'pleated_skirt',name:'褶纹分裳'},{id:'robe_skirt',name:'礼仪阔裤'},{id:'work_pants',name:'劳动直裤'},{id:'guard_pants',name:'束脚行动裤'},{id:'archer_pants',name:'弓手裤'},{id:'body',name:'无下装'}],

import { styleTailoredSurface, addTailoredPanels, type WardrobeLod } from './tailoring';
import { B, rigid, type Cage, type Recipe, type TopId, type BottomId, type HeadwearId, type Vec3, type GarmentDyes } from '../v3/types';
import { ring, bridge, face, OCT, BOX, orient } from '../v3/cage';
...
export { BODY_HIDE_VERSION, GARMENT_GEOMETRY_VERSION } from './tailoring';

...
export default function MountLab() {
  ...
  return <main className="horse-lab mount-lab">
    <header className="horse-topbar"><div><p>WANHU / MOUNT STUDY</p><h1>坐骑工坊 <span>Mount Lab</span></h1></div><WorkspaceSwitcher active="animal"/><span className="horse-phase-tag">PHASE M8 · 多坐骑</span></header>

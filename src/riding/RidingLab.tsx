...
export default function RidingLab() {
  ...
  return <main className="horse-lab riding-lab">
    <header className="horse-topbar"><div><p>WANHU / RIDING STUDY</p><h1>骑乘试衣 <span>Riding Lab</span></h1></div><WorkspaceSwitcher active="animal"/><span className="horse-phase-tag">PHASE M8 · 多坐骑</span></header>
    <div className="horse-workspace">
      ...
      <aside className="horse-inspector riding-inspector">
        ...
        <section className="horse-boundary"><p className="horse-eyebrow">当前范围</p><p>同一人物可骑栗色马、灰驴、双峰骆驼、黄牛、牦牛或水牛。种类切换会适配鞍具、跨坐宽度和缰绳；衣物与人物绑定保持。</p><p>只有静态、停驻、步行和奔跑；进食在坐骑本体页查看。没有上下坐骑、导航、地形IK或玩家移动。</p></section>
      </aside>
    </div>
  </main>;
}

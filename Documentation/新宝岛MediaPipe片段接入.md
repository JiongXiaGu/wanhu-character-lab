...
脚部用脚踝到脚尖决定脚骨的水平朝向与俯仰；相对躯干的偏航限制在 15°，俯仰限制在 −40° 至 −18°，以防单目深度误差让鞋尖翘起或下扎。诊断报告记录两脚达到俯仰边界的帧数。“新宝岛 · MediaPipe”已使用新版前臂转换轨道，修复约 87% 处衣袖扭结；完整重生成时不再保留旧版前臂轨道。生成器会先核对来源哈希、时间轴与原始 33 点。
